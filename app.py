...
def predict_result():
    ...
    result = model.predict([[gender, tenure, phone_service, internet_service, online_security, online_backup, tech_support, contract, paperless_billing, payment_method]])
